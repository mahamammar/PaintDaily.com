...
function Bedroom() {
  return (
    <main>
      ...
      <h2 className={Style.mid_text}>Bathroom</h2>
      ...
      <div id="carouselExampleControls" className="carousel slide slide-top" data-bs-ride="carousel">
               <div className="carousel-inner">
                 <div className="carousel-item active" data-interval="100">
                   <img src={bt4} className={`d-block w-100 ${Style.Img}`} height={'550px'} alt="PaintDaily"/>
                 </div>
                 <div className="carousel-item" data-interval="100">
                   <img src={bt1} className={`d-block w-100 ${Style.Img}`} height={'550px'} alt="PaintDaily"/>
                 </div>
                 <div className="carousel-item" data-interval="100">
                   <img src={bt2} className={`d-block w-100 ${Style.Img}`} height={'550px'} alt="PaintDaily"/>
                 </div>
                 <div className="carousel-item" data-interval="100">
                   <img src={bt3} className={`d-block w-100 ${Style.Img}`} height={'550px'} alt="PaintDaily"/>
                 </div>
                 <div className="carousel-item" data-interval="100">
                   <img src={bt4} className={`d-block w-100 ${Style.Img}`} height={'550px'} alt="PaintDaily"/>
                 </div>
                 <div className="carousel-item" data-interval="100">
                   <img src={bt1} className={`d-block w-100 ${Style.Img}`} height={'515px'} alt="PaintDaily"/>
                 </div>
                 <div className="carousel-item" data-interval="100">
                   <img src={bt2} className={`d-block w-100 ${Style.Img}`} height={'550px'} alt="PaintDaily"/>
                 </div>
                 <div className="carousel-item" data-interval="100">
                   <img src={bt3} className={`d-block w-100 ${Style.Img}`} height={'510px'} alt="PaintDaily"/>
                 </div>
               </div>
