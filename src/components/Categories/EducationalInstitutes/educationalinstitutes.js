...
import Style from './educationalinstitutes.module.css';
import {Link} from 'react-router-dom'
import school from "../../../../src/assets/Images/school.jpg"
...
const Exterior = () => {
    ...
    return (
        <main>
            <Navbar/>
            <img className={Style.pimage} src={school}/>

            <h2 className={Style.pheading}>Educational Institutes</h2>
