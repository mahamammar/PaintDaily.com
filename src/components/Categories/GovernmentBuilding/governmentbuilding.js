...
import {exteriorPaint, govtBuildings} from "../../../utils/categoryArray";
import Style from './governmentbuilding.module.css';
import {Link} from 'react-router-dom'
import gov from "../../../../src/assets/Images/gov.png"
...
const Exterior = () => {
    ...
    return (
        <main>
            <Navbar/>
            <img className={Style.pimage} src={gov}/>

            <h2 className={Style.pheading}>Government Buildings</h2>

<div className={Style.product_side}>
            {govtBuildings.map((data,index)=>(
