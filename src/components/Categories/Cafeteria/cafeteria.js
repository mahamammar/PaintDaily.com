...
import cefeteria from "../../../../src/assets/Images/cefeteria.jpg"
import {cafeteria} from '../../../utils/categoryArray';
...
const Exterior = () => {
    ...
    return (
        <main>
            <Navbar/>
            <img className={Style.pimage} src={cefeteria}/>

            <h2 className={Style.pheading}>Cafeteria Paints</h2>

<div className={Style.product_side}>
            {cafeteria.map((data,index)=>(
