...
import {corporateOffice, exteriorPaint} from "../../../utils/categoryArray";
import Style from './corporateoffice.module.css';
import {Link} from 'react-router-dom'
import ceooffice from "../../../../src/assets/Images/ceooffice.jpg"
...
const Exterior = () => {
    ...
    return (
        <main>
            <Navbar/>
            <img className={Style.pimage} src={ceooffice}/>

            <h2 className={Style.pheading}>Corporate Office</h2>

<div className={Style.product_side}>
            {corporateOffice.map((data,index)=>(
