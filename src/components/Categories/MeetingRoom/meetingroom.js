...
import Style from './meetingroom.module.css';
import {Link} from 'react-router-dom'
import meeting from "../../../../src/assets/Images/meeting.jpg"
...
const Exterior = () => {
    ...
    return (
        <main>
            <Navbar/>
            <img className={Style.pimage} src={meeting}/>

            <h2 className={Style.pheading}>Meeting Room</h2>
